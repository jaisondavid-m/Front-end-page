...
function Herosection() {
  return (
    <div className='motion-preset-rebound-down motion-delay-[900ms] text-white flex flex-col  justify-between mt-8 md:mt-16 lg:mt-32 '>
      <div className='pt-6 px-6 flex flex-col gap-y-5'>
      ...
      <div className='lg:flex justify-between items-end mt-5 lg:mt-10 lg:ps-8'>
        <div className='lg:w-[25%] p-2 text-center pt-10 md:text-2xl md:w-[80%] mx-auto lg:pt-0 md:text-left lg:text-left tracking-tight text-current/0 pb-1'>
          As a multi-award-winning studio,FUTURE THREE® creates award winning websites and sets international standards.
        </div>
        <div className='lg:mx-10 md:mt-14 mt-10 p-3 lg:p-0 lg:w-[50%] flex-wrap gap-x-5 gap-y-1 w-full flex lg:gap-x-10 justify-center items-center h-max bg-gray-950 '>
